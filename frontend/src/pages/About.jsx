...
const About = () => {
  return (
    ...
    <p className='mb-4 text-slate-700'>
      Realty Estate is a leading real estate agency that specializes 
      ...
      to providing exceptional service and making the buying and selling process 
    ...
    <p className='mb-4 text-slate-700'>
      ...
      industry, and we are committed to providing the highest level of service to our clients. 
